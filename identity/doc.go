...
// controls (Issues #46–#48 / CAP-010 / CAP-012 / CAP-013).
//
...
// ops-visibility reads (MX-002 / MX-003), and privileged controls
// (MX-004 / MX-005 / MX-006); missing or unmatched membership is deny.
//
