# SeshatOps web — M1 operations view
...
| `VITE_TENANT_ID` | Northstar fixture tenant | Demo tenant context only (not M2 auth) |
...
3. Process the deterministic Northstar synthetic order through the M1 spine.
...
- No authentication or identity screens (M2+)
...
- [M1_OPERATIONS_VIEW_REVIEW.md](../docs/reviews/M1_OPERATIONS_VIEW_REVIEW.md)
