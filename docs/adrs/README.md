...
| [ADR-0003](0003-event-envelope-and-schema-compatibility.md) | M1 event envelope and schema compatibility | Accepted M1 decision; implementation pending | M1 / M7 evidence |
