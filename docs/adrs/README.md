...
| [ADR-0004](0004-postgresql-inbox-and-projection-consistency.md) | M1 PostgreSQL inbox and projection consistency | Accepted M1 decision; Issue #23 source/outbox implemented; Issue #25 inbox/projection consumer implemented | M1 / M7 evidence |
