...
| ADR-Q-004 | Identity, tenant visibility, policy, and service delegation | Identity | Before identity or operational enforcement is implemented | Default deny, tenant isolation, least privilege, and Go-owned authorization remain required. | Open |
