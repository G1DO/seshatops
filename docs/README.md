...
| Compatibility & toolchain | [COMPATIBILITY.md](COMPATIBILITY.md), [REPRODUCIBILITY.md](REPRODUCIBILITY.md), [event-spine.md](design/specifications/event-spine.md) §9 | Pinned digests, Go/Node/Python/PostgreSQL/Redpanda versions, artifact & checksum identities |
