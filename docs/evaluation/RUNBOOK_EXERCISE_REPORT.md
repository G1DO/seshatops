...
* **Date (UTC)**: 2026-08-25T15:30:00Z
* **Repository commit**: `4653a0e11846be9db165890198f4f76e7a2b7ac9` (`git rev-parse HEAD`)
* **Version**: `4653a0e` (`git describe --always`) — clean worktree; report excluded from `source_digest` (`scripts/release_demo.py:382`)
* **Source SHA-256**: `f01e8cd4e1356f4d136fd29b584c82a2d524bafb194ac00f6001a03f3e3f4795` (`release_demo.source_digest` over `git ls-files` bounded 64 MiB, report excluded)
...
./scripts/local-stack.sh demo all --evidence-dir .release-evidence/runbook-2026-08-25T153000Z
...
* This report was regenerated after the worktree became clean (`worktree_dirty false`, `source_sha256` `f01e8cd4…`); report excluded from digest to keep HEAD self-consistent, no dirty-state retained.
...
* Machine evidence: `.release-evidence/runbook-2026-08-25T153000Z/campaign.json` (when harness run, gitignored) or this report's bounded checksums/metrics/logs excerpts.
