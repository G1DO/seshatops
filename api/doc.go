...
// committed inventory projection, privileged quarantine/replay/rebuild
// POSTs, and append-only audit read.
//
...
// MX-004/MX-005/MX-006 cover privileged POSTs; MX-007 covers GET .../ops/audit
