...
// quarantine/replay/rebuild POSTs.
//
...
// requires MX-004/MX-005/MX-006 on privileged POSTs. Unauthorized callers
// receive 403. SSE notifications are at-least-once and may be dropped
