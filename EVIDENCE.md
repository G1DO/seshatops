...
| `CLM-006` | Unchanged history deterministically rebuilds projections. | Planned | `CAP-015` | M3 | Deterministic replay and checksum comparison | Replay report and checksum artifact | — | Planned | — | — | — | No event history, projection, or checksum implementation exists. | — | — | M1 supplies the initial rebuild invariant; M3 owns recovery replay evidence. |
