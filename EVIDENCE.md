...
| `CLM-007` | Tenant isolation holds across protected operations. | Planned | `CAP-010` | Identity | Cross-tenant negative suite | Security test report and raw denial results | — | Planned | — | — | — | Issue #45 adds OIDC/session library/test runtime; authorization and tenant isolation enforcement do not exist yet. | — | — | Scope must include reads, retrieval, citations, approvals, commands, exports, audit, replay, and recovery. |
