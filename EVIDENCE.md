...
| `CLM-004` | Event processing is duplicate-safe. | Planned | `CAP-007` | M1 | Duplicate-delivery integration test and fault report | Test report and deduplication trace | — | Planned | — | — | — | Issue #25 adds `platform` consumer tests for identical redelivery and post-commit/pre-ack crash windows; claim is not promoted to Observed/Reproduced. | — | — | Must remain distinct from exactly-once delivery claims. |
